...
const { validateUnique, validateEmail, validate, validatePhoneNumber } = require('./utils/validate.js');
...
app.use("/api/v1/current-user", require("./routes/currentUser"))
    ...
    try {
        ...
        const rules = {
            ...
            mobileNumber: {
                ...
                "unique":{table: 'employee', column: "mobile_number", value:employee.mobileNumber},
